...
class WeiXinGongZhongController extends Controller {

    public $appid = "wx29656e8801565344";//正式
    public $appsecret = "7497e4557f2ce8b2c0ba0a0b5edee267";//正式
    ...
    private function actionGetAccessToken(){
        $weixin_access_token = f_c("weixin_access_token2");
        if( $weixin_access_token === false ){
            ...
            f_c("weixin_access_token2",$weixin_access_token,36000);
        } 
